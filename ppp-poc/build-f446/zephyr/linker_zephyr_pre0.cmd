...
MEMORY
    ...
    BACKUP_SRAM : ORIGIN = 1073889280, LENGTH = 4096
...
ztest :
{
 ...
 ppp_protocol_handler_area : SUBALIGN(4) { _ppp_protocol_handler_list_start = .; KEEP(*(SORT_BY_NAME(._ppp_protocol_handler.static.*))); _ppp_protocol_handler_list_end = .; } > FLASH
