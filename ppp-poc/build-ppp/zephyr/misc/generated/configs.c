...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NET_SAMPLE_APP_MAX_ITERATIONS, 500);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NET_SAMPLE_APP_MAX_CONNECTIONS, 0);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZEPHYR_PANDUZAHA_NG_MODULE, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NET_PPP, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NET_PPP_DRV_NAME, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NET_PPP_MTU_MRU, 1500);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NET_PPP_UART_BUF_LEN, 8);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NET_PPP_RINGBUF_SIZE, 256);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NET_PPP_RX_STACK_SIZE, 768);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NET_PPP_RX_PRIORITY, 7);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NET_PPP_VERIFY_FCS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PPP_MAC_ADDR, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PPP_CLIENT_CLIENTSERVER, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NET_PPP_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NET_PPP_LOG_LEVEL, 3);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MODEM_MODULES_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MODEM_MODULES_LOG_LEVEL, 3);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NET_L2_PPP_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NET_L2_PPP_LOG_LEVEL, 3);
